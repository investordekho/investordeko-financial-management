...
<div id="previous-deals-container">
    ...
    <input type="text" class="form-control @error('previous_deal_company') is-invalid @enderror" name="previous_deal_company[]" placeholder="Company" required>
    @error('previous_deal_company.0')
    <span class="text-danger small">This field is required</span>
@enderror
