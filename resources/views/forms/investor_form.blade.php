...
//         'Banking/Mortgage', 'Biotechnology/Greentech', 'Broadcast Media', 'Building Materials',
...
//         'Entertainment/Movie Production', 'Environmental Services', 'Events Services', 'Executive Office',
//         'Facilities Services', 'Farming', 'Financial Services', 'Fine Art', 'Fishery', 'Food Production',
//         'Food/Beverages', 'Fundraising', 'Furniture', 'Gambling/Casinos', 'Glass/Ceramics/Concrete',
//         'Government Administration', 'Government Relations', 'Graphic Design/Web Design', 'Health/Fitness',
//         'Higher Education/Acadamia', 'Hospital/Health Care', 'Hospitality', 'Human Resources/HR', 'Import/Export',
//         'Individual/Family Services', 'Industrial Automation', 'Information Services', 'Information Technology/IT',
//         'Insurance', 'International Affairs', 'International Trade/Development', 'Internet',
//         'Investment Banking/Venture', 'Investment Management/Hedge Fund/Private Equity', 'Judiciary',
//         'Law Enforcement', 'Law Practice/Law Firms', 'Legal Services', 'Legislative Office', 'Leisure/Travel',
//         'Library', 'Logistics/Procurement', 'Luxury Goods/Jewelry', 'Machinery', 'Management Consulting', 'Maritime',
//         'Market Research', 'Marketing/Advertising/Sales', 'Mechanical or Industrial Engineering', 'Media Production',
//         'Medical Equipment', 'Medical Practice', 'Mental Health Care', 'Military Industry', 'Mining/Metals',
//         'Motion Pictures/Film', 'Museums/Institutions', 'Music', 'Nanotechnology', 'Newspapers/Journalism',
//         'Non-Profit/Volunteering', 'Oil/Energy/Solar/Greentech', 'Online Publishing', 'Other Industry',
//         'Outsourcing/Offshoring', 'Package/Freight Delivery', 'Packaging/Containers', 'Paper/Forest Products',
//         'Performing Arts', 'Pharmaceuticals', 'Philanthropy', 'Photography', 'Plastics', 'Political Organization',
//         'Primary/Secondary Education', 'Printing', 'Professional Training', 'Program Development', 'Public Relations/PR',
//         'Public Safety', 'Publishing Industry', 'Railroad Manufacture', 'Ranching', 'Real Estate/Mortgage',
//         'Recreational Facilities/Services', 'Religious Institutions', 'Renewables/Environment', 'Research Industry',
//         'Restaurants', 'Retail Industry', 'Security/Investigations', 'Semiconductors', 'Shipbuilding',
//         'Sporting Goods', 'Sports', 'Staffing/Recruiting', 'Supermarkets', 'Telecommunications', 'Textiles',
//         'Think Tanks', 'Tobacco', 'Translation/Localization', 'Transportation', 'Utilities', 'Venture Capital/VC',
//         'Veterinary', 'Warehousing', 'Wholesale', 'Wine/Spirits', 'Wireless', 'Writing/Editing'
//     ];

//     let sectorOptions = `<option value="" selected hidden>Select Sector</option>`;
...
//                 <select class="previous-investment-year form-control" name="previous_investment_year[]" required>
//                     ${yearOptions}
//                 </select>
//             </div>
//             <div class="col-sm-3 form-group">
//                 <label class="required">Company</label>
//                 <input type="text" class="previous-investment-company form-control" name="previous_investment_company[]" required>
//             </div>
//             <div class="col-sm-3 form-group">
//                 <label class="required">Sector</label>
//                 <select class="sector-select form-control spaced-input" name="sector[]" required>
//                     ${sectorOptions}
//                 </select>
//             </div>
//             <div class="col-sm-1 form-group">
