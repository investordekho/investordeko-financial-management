    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                ...
                <form method="POST" action="<?php echo e(route('verifycode')); ?>"> <!-- Laravel password reset route -->
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\demo\investordeko-financial-management\resources\views/auth/new/verifycode.blade.php ENDPATH**/ ?>