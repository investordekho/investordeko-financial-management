...
<div class="container">
    ...
    <form id="investorForm"
      action="<?php echo e(route('updateinvestorprofile')); ?>"
      method="POST"
...
unset($__errorArgs, $__bag); ?>"
                            id="investor_name"
                            name="investor_name"
                            value="<?php echo e(old('investor_name', $investor->investor_name ?? '')); ?>"
                            required
                            pattern="^[a-zA-Z\s]+$"
...
unset($__errorArgs, $__bag); ?>"
        ...
        value="<?php echo e(implode(', ', $selectedSectors)); ?>"
    >
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php $__currentLoopData = $sectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <label>
                <input
                    ...
                    <?php echo e(in_array($sector, $selectedSectors) ? 'checked' : ''); ?>
    ...
    <div id="sectors_preferred_hidden_container">
        <?php $__currentLoopData = $selectedSectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <input type="hidden" name="sectors_preferred[]" value="<?php echo e($sector); ?>">
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</div>
...
unset($__errorArgs, $__bag); ?>" 
        id="address" 
        name="address" 
        value="<?php echo e(old('address', $investor->address ?? '')); ?>" 
        required
    >
...
<div class="col-sm-3">
    <?php if(!empty($investor->investor_profile)): ?>
        <a href="<?php echo e(asset('storage/investor_profiles/' . $investor->investor_profile)); ?>" target="_blank">
...
unset($__errorArgs, $__bag); ?>" 
            ...
            value="<?php echo e(old('concerned_person_name', $contactDetails->concerned_person_name ?? '')); ?>" 
            required
            pattern="^[a-zA-Z\s]+$"
            title="Please enter a valid name (letters and spaces only)"
            oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')"
...
unset($__errorArgs, $__bag); ?>" 
            ...
            value="<?php echo e(old('concerned_person_designation', $contactDetails->concerned_person_designation ?? '')); ?>" 
            required
            pattern="^[a-zA-Z\s]+$"
...
unset($__errorArgs, $__bag); ?>" 
            ...
            value="<?php echo e(old('concerned_person_phone', $contactDetails->concerned_person_phone ?? '')); ?>" 
            required
        >
...
unset($__errorArgs, $__bag); ?>" 
            id="email" 
            name="email" 
            value="<?php echo e(old('email', $contactDetails->email ?? '')); ?>" 
            required
        >
...
unset($__errorArgs, $__bag); ?>
 ...
 <!-- <pre>
    <?php echo json_encode($publicLinks->map(function($item) {
        return [
            'url' => $item->url,
...
unset($__errorArgs, $__bag); ?>" 
                ...
                >
                    <?php $__currentLoopData = ['Facebook', 'Twitter/X', 'Instagram', 'LinkedIn', 'Others']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($option); ?>" <?php echo e(($descriptions[$i] ?? '') == $option ? 'selected' : ''); ?>>
                            <?php echo e($option); ?>
...
unset($__errorArgs, $__bag); ?>" 
            ...
            required
        >
            <?php $selectedInvestIn = old('invest_in') ?? $investmentDetails->invest_in ?? ''; ?>
            <option value="listed shares" <?php echo e($selectedInvestIn == 'listed shares' ? 'selected' : ''); ?>>Listed shares</option>
            <option value="unlisted shares" <?php echo e($selectedInvestIn == 'unlisted shares' ? 'selected' : ''); ?>>Unlisted shares</option>
            <option value="both" <?php echo e($selectedInvestIn == 'both' ? 'selected' : ''); ?>>Both</option>
        </select>
...
unset($__errorArgs, $__bag); ?>" 
            ...
            required
        >
            <?php $selectedType = old('investor_type') ?? $investmentDetails->investor_type ?? ''; ?>
            <option value="Angel Investor" <?php echo e($selectedType == 'Angel Investor' ? 'selected' : ''); ?>>Angel Investor</option>
            <option value="Private Equity" <?php echo e($selectedType == 'Private Equity' ? 'selected' : ''); ?>>Private Equity</option>
            <option value="Venture Capital" <?php echo e($selectedType == 'Venture Capital' ? 'selected' : ''); ?>>Venture Capital</option>
            <option value="Family Office" <?php echo e($selectedType == 'Family Office' ? 'selected' : ''); ?>>Family Office</option>
        </select>
...
unset($__errorArgs, $__bag); ?>" 
            ...
            required
        >
            <?php $selectedSize = old('investment_size') ?? $investmentDetails->investment_size ?? ''; ?>
            <option value="10 cr" <?php echo e($selectedSize == '10 cr' ? 'selected' : ''); ?>>Less than 10 Cr</option>
            <option value="10-50 Cr" <?php echo e($selectedSize == '10-50 Cr' ? 'selected' : ''); ?>>10 - 50 Cr</option>
            <option value="50-100 Cr" <?php echo e($selectedSize == '50-100 Cr' ? 'selected' : ''); ?>>50 - 100 Cr</option>
            <option value=">100+ Cr" <?php echo e($selectedSize == '>100+ Cr' ? 'selected' : ''); ?>>More than 100 Cr</option>
        </select>
...
unset($__errorArgs, $__bag); ?>" 
            ...
            required
        >
            <?php $selectedTenure = old('investment_tenure') ?? $investmentDetails->investment_tenure ?? ''; ?>
            <option value="1 Years" <?php echo e($selectedTenure == '1 Years' ? 'selected' : ''); ?>>Less than 1 year</option>
            <option value="3 Years" <?php echo e($selectedTenure == '3 Years' ? 'selected' : ''); ?>>1 - 3 years</option>
            <option value="5 Years" <?php echo e($selectedTenure == '5 Years' ? 'selected' : ''); ?>>3 - 5 years</option>
            <option value="7 Years" <?php echo e($selectedTenure == '7 Years' ? 'selected' : ''); ?>>5 - 7 years</option>
        </select>
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            >
                                            <option value="" <?php echo e(!isset($previousInvestmentYears[$i]) || $previousInvestmentYears[$i] == '' ? 'selected' : ''); ?>>Select Year</option>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        >
                                            ...
                                            <?php endif; ?> -->
                                            <!-- <option value="" <?php echo e(empty($sectors[$i]) ? 'selected' : ''); ?>>Select Sector</option> -->
                                            <option value="" <?php echo e(!isset($sectors[$i]) || $sectors[$i] == '' ? 'selected' : ''); ?>>Select Sector</option>
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $sectorOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option); ?>" <?php echo e((isset($sectors[$i]) && $sectors[$i] == $option) ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" id="referral_source" name="referral_source" required>
            ...
            <?php $__currentLoopData = [
                ...
                <option value="<?php echo e($option); ?>" <?php echo e($selectedReferral === $option ? 'selected' : ''); ?>>
                    <?php echo e($option); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\demo\investordeko-financial-management\resources\views/updateforms/investor_form.blade.php ENDPATH**/ ?>