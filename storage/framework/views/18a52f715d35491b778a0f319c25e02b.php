...
<div class="container">
    ...
    <div class="card shadow-lg">
        <div class="card-header text-white" style="background-color:#d6d6c2;">
            <h2 class="mb-0 text-center" style="background-color:#d6d6c2;">Subscription Plan: <?php echo e(ucfirst($plan)); ?></h2>
        </div>
        <div class="card-body">
            <p class="lead text-center">You have selected the <strong><?php echo e(ucfirst($plan)); ?></strong> plan.</p>
