...
<?php endif; ?>
    ...
    <div class="row justify-content-center ">
        <div class="col-md-6 bg-light p-4 rounded shadow-sm">
            <form action="<?php echo e(route('profile.update')); ?>" method="POST" id="profileform" enctype="multipart/form-data" novalidate>
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" id="name" name="name" value="<?php echo e(old('name', Auth::user()->name)); ?>" placeholder="Enter your full name" required pattern="[A-Za-z\s]+" title="Full name should only contain letters and spaces" readonly>
