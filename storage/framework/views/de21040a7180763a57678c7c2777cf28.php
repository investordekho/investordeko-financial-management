    ...
    <div class="container">
        ...
        <div class="row g-4 align-items-end mb-4" style="padding-bottom: 40px;">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <img src="<?php echo e(asset('img/about.jpg')); ?>" alt="About Us" class="about-img shadow-lg" style="max-width: 100%; border-radius: 10px;">
            </div>
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\demo\investordeko-financial-management\resources\views/about.blade.php ENDPATH**/ ?>