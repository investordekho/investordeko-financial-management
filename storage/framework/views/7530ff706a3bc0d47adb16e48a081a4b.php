...
<div class="container">
    ...
    <!-- Form Section -->
    <form id="othersForm" action="<?php echo e(route('form.other.submit')); ?>" method="POST" enctype="multipart/form-data" class="bg-white p-4 rounded-bottom shadow-sm mt-0" novalidate>
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-4">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control spaced-input" id="full_name" name="full_name" value="<?php echo e(old('full_name')); ?>" required  pattern="^[a-zA-Z\s]+$"
        ...
        <div class="mb-4">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control spaced-input" id="city" name="city" value="<?php echo e(old('city')); ?>" required pattern="^[a-zA-Z\s]+$"
        title="Please enter a valid name (letters and spaces only)"
        oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control spaced-input" id="state" name="state" value="<?php echo e(old('state')); ?>" required pattern="^[a-zA-Z\s]+$"
        title="Please enter a valid name (letters and spaces only)"
        oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control spaced-input" id="country" name="country" value="<?php echo e(old('country')); ?>" required pattern="^[a-zA-Z\s]+$"
        title="Please enter a valid name (letters and spaces only)"
        oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')">
        ...
        <div class="mb-4">
            ...
            <div class="form-floating">
                <select class="form-select spaced-input" id="referral_source" name="referral_source" required>
                    ...
                    <option value="Social Media (Facebook, Instagram, Twitter/X, etc.)" <?php echo e(old('referral_source') == 'Social Media (Facebook, Instagram, Twitter/X, etc.)' ? 'selected' : ''); ?>>Social Media</option>
