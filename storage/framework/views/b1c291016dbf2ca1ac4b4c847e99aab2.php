...
<div class="container">
    <div class="col-sm-12">
                ...
                <form id="investorForm" action="<?php echo e(route('form.investor.submit')); ?>" method="POST" enctype="multipart/form-data" class="bg-light p-5 rounded shadow-sm" novalidate>
                    <?php echo csrf_field(); ?>
