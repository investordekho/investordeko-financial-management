                            ...
                            <div class="row-g-1">
                                <div class="col-md-12">
                                    <div class="search-box p-1 bg-light rounded shadow-sm">
                                        ...
                                        <input type="text" class="form-control" id="searchBox2" name="searchBox2" placeholder="Eg. Company Name, Sector, Location">
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <ul style="padding-left: 0px;" id="locationList2" class="dropdown-menu scrollable-menu">
                                                <div class="px-3 py-2">
                                                    ...
                                                    <ul style="padding-left: 0px;">
                                                        ...
                                                        <li class="dropdown-item">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox" name="location2[]" value="<?php echo e($location->name); ?>" id="location_<?php echo e($location->name); ?>">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchResults() {
            ...
            formData.append('searchBox2', searchBoxValue); // Ensure searchBox value is included
        ...
        function updateBreadcrumb() {
            ...
            if (searchBoxValue && searchBoxValue.trim() !== '') {
                addFilterToBreadcrumb('searchBox2', searchBoxValue); // Add searchBox filter
            }
        }
    ...
    fetchResults();  // Fetch results
        ...
        function updateSelectedFilters() {
            ...
            selectedFilters['searchBox2'] = ''; // Initialize as an empty string
            const searchBoxValue = document.getElementById('searchBox2').value.trim();
            if (searchBoxValue) {
                selectedFilters['searchBox2'] = searchBoxValue; // Add searchBox to selected filters
            } else {
                delete selectedFilters['searchBox2']; // Remove searchBox if empty
            }
        }
