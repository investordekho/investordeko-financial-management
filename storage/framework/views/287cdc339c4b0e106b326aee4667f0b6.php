...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        name="public_links[]" 
                        placeholder="URL" 
                        value="<?php echo e(old('public_links.'.$i)); ?>"
                    >
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    >
                        <option value="" disabled <?php echo e(old('link_descriptions.'.$i) ? '' : 'selected'); ?>>Select Account</option>
                        <option value="Facebook" <?php echo e(old('link_descriptions.'.$i) == 'Facebook' ? 'selected' : ''); ?>>Facebook</option>
                        <option value="Twitter/X" <?php echo e(old('link_descriptions.'.$i) == 'Twitter/X' ? 'selected' : ''); ?>>Twitter/X</option>
                        <option value="Linkedin" <?php echo e(old('link_descriptions.'.$i) == 'Linkedin' ? 'selected' : ''); ?>>Linkedin</option>
                        <option value="Others" <?php echo e(old('link_descriptions.'.$i) == 'Others' ? 'selected' : ''); ?>>Others</option>
                    </select>
