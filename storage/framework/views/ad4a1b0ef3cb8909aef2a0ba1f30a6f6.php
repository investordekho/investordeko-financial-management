...
unset($__errorArgs, $__bag); ?>"
                id="nature_of_business"
                name="nature_of_business"
                value="<?php echo e(old('nature_of_business' , $company->nature_of_business ?? '')); ?>"
                required
            >
            <?php $__errorArgs = ['nature_of_business'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>" 
            ...
            >
                ...
                <?php for($year = date('Y'); $year >= 1901; $year--): ?>
                    <option value="<?php echo e($year); ?>" <?php echo e(old('incorporated_in', $company->incorporated_in ?? '') == $year ? 'selected' : ''); ?>>
                        <?php echo e($year); ?>
...
unset($__errorArgs, $__bag); ?>" 
                    id="concerned_person_name" 
                    name="concerned_person_name" 
                    value="<?php echo e(old('concerned_person_name', $concernedPerson->name ?? '')); ?>" 
                    required
                    pattern="^[A-Za-z\s\.\-&']+$"
                    title="Only letters, spaces, dots, hyphens, ampersands, and apostrophes are allowed."
                    oninput="this.value = this.value.replace(/[^A-Za-z\s.\-&']/g, '')"
...
unset($__errorArgs, $__bag); ?>" 
                    id="concerned_person_designation" 
                    name="concerned_person_designation" 
                    value="<?php echo e(old('concerned_person_designation' , $concernedPerson->designation ?? '')); ?>" 
                    required
                    pattern="^[A-Za-z\s\.\-&']+$"
                    title="Only letters, spaces, dots, hyphens, ampersands, and apostrophes are allowed."
                    oninput="this.value = this.value.replace(/[^A-Za-z\s.\-&']/g, '')"
...
unset($__errorArgs, $__bag); ?>" 
                    id="concerned_person_email" 
                    name="concerned_person_email" 
                    value="<?php echo e(old('concerned_person_email' , $concernedPerson->email ?? '')); ?>" 
                    required
                >
            </div>
...
unset($__errorArgs, $__bag); ?>" 
                    id="concerned_person_phone" 
                    name="concerned_person_phone" 
                    value="<?php echo e(old('concerned_person_phone' , $concernedPerson->phone ?? '')); ?>" 
                    maxlength="20" 
                    pattern="^\+?[0-9]{7,20}$" 
...
<div class="row g-3 mt-3">
    ...
    <div class="col-sm-10" id="public-links-container">
        <?php $__empty_1 = true; $__currentLoopData = $otherLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="row g-0 mb-3">
                <div class="col-sm-5">
                    <input 
...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        name="public_links[]" 
                        placeholder="URL" 
                        value="<?php echo e(old("public_links.$index", $link->link_url)); ?>"
                    >
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-sm-5">
                    <select 
                        class="form-control <?php $__errorArgs = ["link_descriptions.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                        name="link_descriptions[]"
                    >
                        <option value="" disabled <?php echo e(old("link_descriptions.$index", $link->link_description) ? '' : 'selected'); ?>>Select Account</option>
                        <option value="Facebook" <?php echo e(old("link_descriptions.$index", $link->link_description) == 'Facebook' ? 'selected' : ''); ?>>Facebook</option>
                        <option value="Twitter/X" <?php echo e(old("link_descriptions.$index", $link->link_description) == 'Twitter/X' ? 'selected' : ''); ?>>Twitter/X</option>
                        <option value="Others" <?php echo e(old("link_descriptions.$index", $link->link_description) == 'Others' ? 'selected' : ''); ?>>Others</option>
                    </select>
    ...
    <div class="row g-3 align-items-end">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $founders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $founder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="row g-3 align-items-end mb-2">
                <input type="hidden" name="founder_ids[]" value="<?php echo e($founder->id); ?>">

                <!-- Name -->
                <div class="col-md-2">
                    <label class="required">Name <span class="text-danger">*</span></label>
                    <input type="text"
                        class="form-control <?php $__errorArgs = ['founder_name.' . $index];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        name="founder_name[]"
                        value="<?php echo e(old('founder_name.' . $index, $founder->name)); ?>"
                        pattern="^[A-Za-z\s\.\-&']+$"
                        title="Only letters, spaces, dots, hyphens, ampersands, and apostrophes are allowed."
                        oninput="this.value = this.value.replace(/[^A-Za-z\s.\-&']/g, '')"
                        required>
                    <?php $__errorArgs = ['founder_name.' . $index];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-2">
                    ...
                    <select 
                        class="form-control <?php $__errorArgs = ['founder_position.' . $index];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($pos); ?>" <?php echo e(old('founder_position.' . $index, $founder->position) == $pos ? 'selected' : ''); ?>><?php echo e($pos); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php $__errorArgs = ['founder_position.' . $index];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-2">
                    ...
                    <input type="text"
                        class="form-control <?php $__errorArgs = ['founder_education.' . $index];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        name="founder_education[]"
                        value="<?php echo e(old('founder_education.' . $index, $founder->education)); ?>"
                        pattern="^[A-Za-z\s\.\-&']+$"
                        title="Only letters, spaces, dots, hyphens, ampersands, and apostrophes are allowed."
                        oninput="this.value = this.value.replace(/[^A-Za-z\s.\-&']/g, '')"
                        required>
                    <?php $__errorArgs = ['founder_education.' . $index];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number"
                        class="form-control <?php $__errorArgs = ['founder_experience.' . $index];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        name="founder_experience[]"
                        value="<?php echo e(old('founder_experience.' . $index, $founder->experience)); ?>"
                        step="0.1"
                        min="0.1"
                        max="100"
                    ...
                    <?php $__errorArgs = ['founder_experience.' . $index];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<div id="funds-container" class="mb-4">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $fundRequirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $fund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="row mb-3 align-items-end">
        <input type="hidden" name="fund_ids[]" value="<?php echo e($fund->id); ?>">

        <!-- Usage -->
        <div class="col-md-3">
            <label id="labelinput" class="required">Usage of Fund <span style="color:red;">*</span></label>
            <select 
                class="form-control spaced-input <?php $__errorArgs = ["fund_usage.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                ...
                required
            >
                <option value="" disabled <?php echo e(old("fund_usage.$index", $fund->usage) ? '' : 'selected'); ?>>Select Usage</option>
                <option value="Capex" <?php echo e(old("fund_usage.$index", $fund->usage) == 'Capex' ? 'selected' : ''); ?>>Capex</option>
                <option value="Opex" <?php echo e(old("fund_usage.$index", $fund->usage) == 'Opex' ? 'selected' : ''); ?>>Opex</option>
                <option value="Acquisition" <?php echo e(old("fund_usage.$index", $fund->usage) == 'Acquisition' ? 'selected' : ''); ?>>Acquisition</option>
                <option value="Debt Requirement" <?php echo e(old("fund_usage.$index", $fund->usage) == 'Debt Requirement' ? 'selected' : ''); ?>>Debt Requirement</option>
                <option value="Others" <?php echo e(old("fund_usage.$index", $fund->usage) == 'Others' ? 'selected' : ''); ?>>Others</option>
            </select>
            <?php $__errorArgs = ["fund_usage.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-8">
            ...
            <div class="input-group">
                <input 
                    class="form-control spaced-input <?php $__errorArgs = ["fund_requirement.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                    type="number" 
                    name="fund_requirement[]" 
                    value="<?php echo e(old("fund_requirement.$index", $fund->amount)); ?>" 
                    min="1"
                    step="0.01"
                    required
                    oninput="if (this.value < 1) this.value = ''"
                ...
                <select 
                    class="form-select spaced-input <?php $__errorArgs = ["fund_unit.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    required
                >
                    <option value="crores" <?php echo e(old("fund_unit.$index", $fund->unit) == 'crores' ? 'selected' : ''); ?>>Cr</option>
                    <option value="lakhs" <?php echo e(old("fund_unit.$index", $fund->unit) == 'lakhs' ? 'selected' : ''); ?>>Lakh</option>
                </select>
            </div>
            <?php $__errorArgs = ["fund_requirement.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            <?php $__errorArgs = ["fund_unit.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<div id="previous-rounds-container" class="mb-4 p-4 bg-white rounded-lg border shadow-sm">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $previousRounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $round): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="row mb-3">
        <input type="hidden" name="previous_round_ids[]" value="<?php echo e($round->id); ?>">

        <div class="col-md-2">
            <label class="form-label required">Previous Round <span class="text-danger">*</span></label>
            <select 
                class="form-select <?php $__errorArgs = ["previous_rounds.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                ...
                required
            >
                <option value="" disabled <?php echo e(old("previous_rounds.$index", $round->round) ? '' : 'selected'); ?>>Select Round</option>
                <?php $__currentLoopData = ['Pre seed round', 'Seed Round', 'Series A round', 'Series B round', 'Series C round', 'Series D round', 'Series E and beyond']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($option); ?>" <?php echo e(old("previous_rounds.$index", $round->round) == $option ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <?php $__errorArgs = ["previous_rounds.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-3">
            ...
            <input 
                type="text" 
                class="form-control <?php $__errorArgs = ["investors.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                name="investors[]" 
                value="<?php echo e(old("investors.$index", $round->investors)); ?>" 
                required
                pattern="^[A-Za-z\s\.\-&']+$"
                title="Only letters, spaces, dots, hyphens, ampersands, and apostrophes are allowed."
                oninput="this.value = this.value.replace(/[^A-Za-z\s.\-&']/g, '')"
            >
            <?php $__errorArgs = ["investors.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-3">
            ...
            <input 
                type="number" 
                class="form-control <?php $__errorArgs = ["amount_raised.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                name="amount_raised[]" 
                value="<?php echo e(old("amount_raised.$index", $round->amount_raised)); ?>" 
                min="0.01" 
                step="0.01" 
                oninput="if (this.value < 0) this.value = ''"
                required
            >
            <?php $__errorArgs = ["amount_raised.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-3">
            ...
            <input 
                type="number" 
                class="form-control <?php $__errorArgs = ["valuation.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                name="valuation[]" 
                value="<?php echo e(old("valuation.$index", $round->valuation)); ?>" 
                min="0.01" 
                step="0.01" 
                oninput="if (this.value <= 0) this.value = ''"
                required
            >
            <?php $__errorArgs = ["valuation.$index"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row align-items-end mb-3">
            <div class="col-md-3">
                ...
                <select name="fiscal_year[]" class="form-control <?php $__errorArgs = ['fiscal_year.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php endif; ?>
    ...
    <input 
        ...
        class="form-control <?php $__errorArgs = ['other_attachment'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\demo\investordeko-financial-management\resources\views/updateforms/investee_form.blade.php ENDPATH**/ ?>