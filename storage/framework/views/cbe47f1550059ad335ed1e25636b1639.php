...
<body>
    <div class="container">
        ...
        <p><?php echo e($user_message); ?></p>
        <div class="footer">
            <p>If you did not expect this message, please ignore it.</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\demo\investordeko-financial-management\resources\views/auth/mailcreation/contactmail.blade.php ENDPATH**/ ?>